  ...
  const compressImage = (file) => {
    ...
    reader.onload = (event) => {
      ...
      img.onload = () => {
        ...
        const maxWidth = 500; // Setting the max width
        const maxHeight = 500; // Setting the max height
        ...
        // Converting to compressed base64
    ...
    <div className="p-4 w-full">
      ...
      <form onSubmit={handleSendImage} className="flex items-center gap-2">
        <div className="flex-1 flex gap-2">
          ...
          >
            <ImageIcon size={20} /> {/* Use ImageIcon instead of Image */}
          </button>
        </div>
        <button
          type="submit"
